  ...
  return (
    <section id="contact" className="bg-brand-bg border-t border-brand-border">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        >
          <span className="text-brand-accent uppercase tracking-[0.4em] text-[10px] font-bold block mb-4">{t.contact.label}</span>
          <h2 className="text-5xl md:text-7xl font-serif italic mb-12">{t.contact.heading}</h2>
          ...
          <div className="space-y-12">
            ...
            <div className="flex items-start gap-8">
              <div className="px-8 border-l border-brand-accent">
                ...
                <p className="text-[10px] text-brand-dark/40 mt-1 uppercase font-bold tracking-widest">{t.contact.walkIns}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-8">
              <div className="px-8 border-l border-brand-accent">
                ...
                <ul className="text-sm text-brand-dark/70 space-y-2">
                  ...
                  <li className="flex justify-between w-64 text-brand-dark/40 italic"><span>{t.contact.sunday}</span> <span>{t.contact.closed}</span></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        >
          <h3 className="text-3xl font-serif mb-10 italic">{t.contact.formHeading}</h3>
          <form className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="border-b border-brand-border pb-2">
                <label className="block text-[8px] uppercase tracking-widest font-bold mb-2 text-brand-accent">{t.contact.fullName}</label>
                <input type="text" className="w-full bg-transparent outline-none py-2 text-sm" placeholder={t.contact.namePlaceholder} />
              </div>
              <div className="border-b border-brand-border pb-2">
                <label className="block text-[8px] uppercase tracking-widest font-bold mb-2 text-brand-accent">{t.contact.mobilePhone}</label>
                <input type="tel" className="w-full bg-transparent outline-none py-2 text-sm" placeholder="(702) 000-0000" />
              </div>
            </div>
            <div className="border-b border-brand-border pb-2">
              <label className="block text-[8px] uppercase tracking-widest font-bold mb-2 text-brand-accent">{t.contact.desiredService}</label>
            ...
            <div className="border-b border-brand-border pb-2">
              <label className="block text-[8px] uppercase tracking-widest font-bold mb-2 text-brand-accent">{t.contact.note}</label>
              <textarea rows={4} className="w-full bg-transparent outline-none py-2 text-sm" placeholder={t.contact.notePlaceholder}></textarea>
            </div>
