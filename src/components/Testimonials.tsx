    ...
    <section id="reviews" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-20 flex flex-col items-center">
          ...
          <h2 className="text-5xl md:text-7xl font-serif italic mb-10">{t.testimonials.heading}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 border-t border-l border-brand-border">
          {REVIEWS.map((review, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className={`p-12 border-r border-b border-brand-border flex flex-col justify-between block-hover ${
                index % 2 === 1 ? 'bg-brand-offwhite' : 'bg-white'
              }`}
            >
              <div>
