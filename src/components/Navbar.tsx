...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 border-b ${scrolled ? 'bg-white border-brand-border py-3' : 'bg-transparent border-transparent py-6'}`}>
